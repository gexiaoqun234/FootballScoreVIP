...
// MARK:- Cell计算尺寸
#define RedUserCollectionCellWeight     TWScreenWidth / 5
#define RedUserCollectionCellHeight     RedUserCollectionCellWeight * 1.2
#define FamousListCollectionCellWeight  TWScreenWidth / 4
#define FamousListCollectionCellHeight  FamousListCollectionCellWeight * 1.2
#define SCREEN_SIZE [UIScreen mainScreen].bounds.size
// 组头
#define TableViewSectionHeaderHeight 45
#define TWPlanforecastitemHeight     75
...
#define TWWebViewStatueColor        TWColorRGB(223, 64, 68)
