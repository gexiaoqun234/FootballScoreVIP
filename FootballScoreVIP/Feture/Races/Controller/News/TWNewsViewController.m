...
@interface TWNewsViewController ()<UIScrollViewDelegate, TitleViewDelegate>
...
@property (nonatomic, strong) TWNewsFootBallViewController * footballVC;
@property (nonatomic, strong) TWNewsBaseBallViewController * baseballVC;
@property (nonatomic, strong) TWNewsNumberViewController * numberVC;
@end

@implementation TWNewsViewController
...
- (NSMutableArray *)titleArray{
    if (!_titleArray) {
        ...
        model2.name = @"篮球";
        TitleNameModel * model3 = [[TitleNameModel alloc]init];
        model3.name = @"数字彩";
...
- (void)initAllSubViewController{
    _footballVC = [[TWNewsFootBallViewController alloc]init];
    [self addChildViewController:_footballVC];
    _baseballVC = [[TWNewsBaseBallViewController alloc]init];
    [self addChildViewController:_baseballVC];
    _numberVC = [[TWNewsNumberViewController alloc]init];
